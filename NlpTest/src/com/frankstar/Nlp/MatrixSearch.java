...
//		System.out.println("listi :" + listi);
		...
		//增加第二次 变4个
		List fourthOutList = addWord(allList);
		allList.addAll(filterWords(fourthOutList));
		
		//增加第三次 变5个
		List fithOutList = addWord(allList);
		allList.addAll(filterWords(fithOutList));
		
		//增加第四次 变6个
		List sixthOutList = addWord(allList);
		allList.addAll(filterWords(sixthOutList));
		
		//增加第五次 变7个 (最长)
		List seventhOutList = addWord(allList);
		allList.addAll(filterWords(seventhOutList));

		
//		System.out.println(outList);
//		System.out.println(outListi);
//		System.out.println(outMergeList);
		wordSet = new HashSet(allList);
...
public class MatrixSearch {
	public String solution(String[] dictionary, Set<String> words){
	...
	public static void main(String[] args) {
		...
		String[] dictionary = {"猴年","年会","足球俱乐部","哈哈"};
		String result = new MatrixSearch().solution(dictionary, words);
