...
<body>
	<%
		...
		out.println(pageContext.getAttribute("session") + "<br>");
		out.println(pageContext.getAttribute("session2") + "<br>");
		out.println(pageContext.getAttribute("request2") + "<br>");
		out.println(pageContext.getAttribute("app") + "<br>");
		out.println(pageContext.getAttribute("app2") + "<br>");
	%>
</body>
</html>